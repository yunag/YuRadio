...
if(NOT DEFINED OBS_VERSION_OVERRIDE AND EXISTS
  ...
  if(_obs_version_result EQUAL 0)
    string(REGEX REPLACE "([0-9]+)\\.([0-9]+)\\.([0-9]+).*" "\\1;\\2;\\3"
                         _obs_version_canonical ${_obs_version})
  endif()
...
message("MAJOR ${OBS_VERSION_MAJOR}")
message("MINOR ${OBS_VERSION_MINOR}")
message("PATCH ${OBS_VERSION_PATCH}")
