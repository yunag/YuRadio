...
static const QString mprisRootInterface =
...
MprisRootAdaptor::MprisRootAdaptor(MprisPlayer *parent)
  ...
  connect(parent, SIGNAL(canSetFullscreenChanged()), this,
          SLOT(onCanSetFullscreenChanged()));
  connect(parent, SIGNAL(desktopEntryChanged()), this,
          SLOT(onDesktopEntryChanged()));
  connect(parent, SIGNAL(fullscreenChanged()), this,
          SLOT(onFullscreenChanged()));
  connect(parent, SIGNAL(hasTrackListChanged()), this,
          SLOT(onHasTrackListChanged()));
  connect(parent, SIGNAL(identityChanged()), this, SLOT(onIdentityChanged()));
  connect(parent, SIGNAL(supportedUriSchemesChanged()), this,
          SLOT(onSupportedUriSchemesChanged()));
  connect(parent, SIGNAL(supportedMimeTypesChanged()), this,
          SLOT(onSupportedMimeTypesChanged()));
}
...
void MprisRootAdaptor::Quit() {
  ...
  player->sendErrorReply(QDBusError::NotSupported,
                         QStringLiteral("Quit requested but not supported."));
}
...
void MprisRootAdaptor::Raise() {
  ...
  player->sendErrorReply(QDBusError::NotSupported,
                         QStringLiteral("Raise requested but not supported."));
}
...
void MprisRootAdaptor::onCanQuitChanged() const {
  ...
  player->notifyPropertiesChanged(mprisRootInterface, changedProperties,
                                  QStringList());
}
...
void MprisRootAdaptor::onCanSetFullscreenChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("CanSetFullscreen")] =
    QVariant(player->canSetFullscreen());
...
void MprisRootAdaptor::onDesktopEntryChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("DesktopEntry")] =
    QVariant(player->desktopEntry());
...
void MprisRootAdaptor::onFullscreenChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("Fullscreen")] =
    QVariant(player->fullscreen());
...
void MprisRootAdaptor::onHasTrackListChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("HasTrackList")] =
    QVariant(player->hasTrackList());
...
void MprisRootAdaptor::onSupportedUriSchemesChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("SupportedUriSchemes")] =
    QVariant(player->supportedUriSchemes());
...
void MprisRootAdaptor::onSupportedMimeTypesChanged() const {
  ...
  QVariantMap changedProperties;
  changedProperties[QStringLiteral("SupportedMimeTypes")] =
    QVariant(player->supportedMimeTypes());
