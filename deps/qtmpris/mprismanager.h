...
class MPRIS_QT_EXPORT MprisManager : public QObject {
  ...
  Q_PROPERTY(bool singleService READ singleService WRITE setSingleService NOTIFY
               singleServiceChanged)
  Q_PROPERTY(QString currentService READ currentService WRITE setCurrentService
               NOTIFY currentServiceChanged)
  Q_PROPERTY(QStringList availableServices READ availableServices NOTIFY
  ...
  Q_PROPERTY(Mpris::PlaybackStatus playbackStatus READ playbackStatus NOTIFY
...
public:
  ...
  Q_INVOKABLE bool setPosition(const QString &trackId,
...
private Q_SLOTS:
  void onNameOwnerChanged(const QString &service, const QString &oldOwner,
